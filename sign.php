...
<head>
    <meta charset="UTF-8">
    <title>KBP_Katta</title>
    <link rel="stylesheet" href="assets/css/style.css">
</head>

<body>
    <div class="header">
        <div class="logo">KBP_Katta</div>
    ...
    <div class="main" style="width:100%;">
        <div class="left-side">
            <!-- <div class="slider">
                <img src="user\1\postImage\Holi.jpg" alt="Image 1">
                <img src="user\1\postImage\Holi.jpg" alt="Image 2">
                <img src="user\1\postImage\Holi.jpg" alt="Image 3">
                <img src="user\1\postImage\Holi.jpg" alt="Image 1">
                <img src="user\1\postImage\Holi.jpg" alt="Image 2">
                <img src="user\1\postImage\Holi.jpg" alt="Image 3">
                <img src="user\1\postImage\Holi.jpg" alt="Image 1">
            ...
            <form action="sign.php" method="post" name="user-sign-up">
                <div class="sign-up-form">
                    ...
                    <div class="sign-wrap-mobile">
                        <input type="text" name="email-mobile" id="up-email" placeholder="Email address" class="text-input">
                    </div>
