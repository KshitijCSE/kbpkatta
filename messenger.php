    ...
    <script>
        $(document).ready(function() {
            ...
            function userLoad() {
                ...
                $.post('http://localhost/KBPKatta/core/ajax/mesgFetch.php', {
                    loadUserid: userid
                }, function(data) {
            ...
            setTimeout(function() {
                $(document).on('keyup', '.emojionearea .emojionearea-editor', function(e) {
                    if (e.keyCode == 13) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "http://localhost/KBPKatta/core/ajax/message.php",
                            data: {
            ...
            function loadMessage() {
                ...
                $.post('http://localhost/KBPKatta/core/ajax/message.php', {
                    dataCount: otheridd,
                    profileid: useridd
                }, function(data) {
