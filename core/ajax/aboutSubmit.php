...
<div class="overview-wrap" style="flex-basis:70%; ">
    <div class="overview-left">
        ...
        <div class="about-border"></div>
        <?php $loadFromPost->aboutOverviewAlt('address', $userid, $profileid, 'Add your current branch'); ?>
...
<div class="overview-wrap">
    <div class="overview-left">
        ...
        <div class="about-border"></div>
        <?php $loadFromPost->aboutOverview('workplace', $userid, $profileid, 'Add work'); ?>
...
<div class="overview-wrap">
    <div class="overview-left">
        <div class="about-work-heading">Instrested Domain</div>
        <div class="about-border"></div>
        <?php $loadFromPost->aboutOverview('currentCity', $userid, $profileid, 'Add your instrested domain'); ?>

        <div class="about-work-heading">Hobbies</div>
        <div class="about-border"></div>
        <?php $loadFromPost->aboutOverview('hometown', $userid, $profileid, 'Add hobbies'); ?>
        <div class="about-work-heading">OTHER </div>
        <div class="about-border"></div>
        <?php $loadFromPost->aboutOverviewAlt('otherPlace', $userid, $profileid, 'Add other '); ?>
    </div>
</div>
...
<div class="overview-wrap" style="">
    <div class="overview-left">
        ...
        <div class="contact-id" style="width: 100%;display:flex; ">
            <div class="contact-id-text setting" style="flex-basis:40%">KBPKatta</div>
        ...
        <!--<div class="contact-birthyear setting" style="width: 100%;display:flex; ">
            ...
            <div class="contact-birthyear-date" style="flex-basis:60%;font-size: 13px;color: black;"><?php echo $userdata->birthYear;?></div>
        </div>-->
        <div class="about-border "></div>
...
<div class="overview-wrap" style="">
    <div class="overview-left">
        <div class="about-work-heading">Achievments</div>
        <div class="about-border"></div>
        <div class="contact-add-life-event" style="width: 100%;display:flex;color: #3578e5;cursor: pointer; ">
            <?php  $loadFromPost->aboutOverviewAlt('lifeEvent', $user_id, $profileid, 'Add your achievments' );?>
        </div>
    </div>
</div>
