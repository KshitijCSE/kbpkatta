$(document).ready(function(){
    ...
    $(document).on('click', 'li.overview', function(){
        ...
        $.post('http://localhost/KBPKatta/core/ajax/aboutSubmit.php', {
            overview: userid,
            profileid: profileid
        }, function(data){
...
$('.hideAboutFieldRestoreHeading').text(heading);
    ...
    showAboutField('workplace', 'Your Admission year');
    ...
    showAboutField('hometown', 'Add instrested domain');
    showAboutField('address', 'Branch');
    ...
    showAboutField('lifeEvent', 'Add achievemnts');
         ...
         container.push($('.db-return'));
                    ...
                    $.each(container, function(key, value) {
                        if (!$(value).is(e.target) && $(value).has(e.target).length === 0) {
                            ...
                            $.post('http://localhost/KBPKatta/core/ajax/aboutFieldRestore.php',{
                                addDataType: addData,
