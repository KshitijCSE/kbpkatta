    ...
    <header>
        <div class="top-bar">
            <div class="top-left-part">
                <div class="profile-logo"><img src="assets/image/kbp.jpeg" alt=""></div>
                        ...
                        <div class="about-main">
                            <div class="about-menu">
                                <ul>
                                    ...
                                    <li class="work-education" data-userid="<?php echo $userid; ?>" data-profileid="<?php echo $profileId; ?>"><span data-userid="<?php echo $userid; ?>" data-profileid="<?php echo $profileId; ?>">Education and Skills</span></li>
                                    <li class="places-lived" data-userid="<?php echo $userid; ?>" data-profileid="<?php echo $profileId; ?>"><span data-userid="<?php echo $userid; ?>" data-profileid="<?php echo $profileId; ?>">Area of Interest</span></li>
                                    ...
                                    <li class="life-events" data-userid="<?php echo $userid; ?>" data-profileid="<?php echo $profileId; ?>"><span data-userid="<?php echo $userid; ?>" data-profileid="<?php echo $profileId; ?>">Acheivments</span></li>
                                </ul>
                            </div>
                            <div class="about-menu-details">
                                <div class="overview-wrap" style="flex-basis:70%; ">
                                    <div class="overview-left">
                                        <div class="about-work-heading">Year</div>
                                        <div class="about-border"></div>
                                        <?php $loadFromPost->aboutOverview('workplace', $userid, $profileId, 'Add your admission year'); ?>

                                        <div class="about-work-heading">University</div>
                                        <div class="about-border"></div>
                                        <?php $loadFromPost->aboutOverview('highSchool', $userid, $profileId, 'Add University'); ?>
                                        <div class="about-work-heading">Branch</div>
                                        <div class="about-border"></div>
                                        <?php $loadFromPost->aboutOverviewAlt('address', $userid, $profileId, 'Add current branch'); ?>
    ...
    <script>
        $(function() {
            ...
            $(document).on('change', '#profile-upload', function() {
                ...
                if (name != '') {
                    $.post('http://localhost/KBPKatta/core/ajax/profilePhoto.php', {
                        imgName: imgName,
                        userid: userid
                    }, function(data) {
                        //                            $('#adv_dem').html(/data);
                    ...
                    $.ajax({
                        url: 'http://localhost/KBPKatta/core/ajax/profilePhoto.php',
                        cache: false,
                        contentType: false,
                        processData: false,
                        data: form_data,
            ...
            $('#cover-upload').on('change', function() {
                ...
                if (name != '') {
                    $.post('http://localhost/KBPKatta/core/ajax/profile.php', {
                        imgName: imgName,
                        userid: userid
                    }, function(data) {
                        //                            alert(data);
                ...
                $.ajax({
                    url: 'http://localhost/KBPKatta/core/ajax/profile.php',
                    cache: false,
                    contentType: false,
                    processData: false,
                    data: form_data,
            ...
            $('.status-share-button').on('click', function() {
                ...
                if (files.length != 0) {
                    if (files.length > 5) {
                        error_images += 'You can not select more than 5 images';
                    } else {
                    ...
                    if (error_images == '') {
                        $.ajax({
                            url: 'http://localhost/KBPKatta/core/ajax/uploadPostImage.php',
                            method: "POST",
                            data: formData,
                            contentType: false,
                            cache: false,
                ...
                if (stIm == '') {
                    $.post('http://localhost/KBPKatta/core/ajax/postSubmit.php', {
            ...
            $(document).on('click', '.edit-post-save', function() {
                ...
                $.post('http://localhost/KBPKatta/core/ajax/editPost.php', {
            ...
            function mainReactSubmit(typeR, postId, userId, nf_3) {
                ...
                $.post('http://localhost/KBPKatta/core/ajax/react.php', {
                    reactType: typeR,
                    postId: postId,
                    userId: userId,
                    profileid: profileid
            ...
            $('.comment-submit').keyup(function(e) {
                if (e.keyCode == 13) {
                    ...
                    if (comment == '') {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "http://localhost/KBPKatta/core/ajax/comment.php",
                            data: {
                                comment: comment,
                                userid: userid,
                                postid: postid,
            ...
            function comReactSubmit(typeR, postid, userid, commentID, com_nf_3) {
                var profileid = "<?php echo $profileId; ?>";
                $.post('http://localhost/KBPKatta/core/ajax/commentReact.php', {
                        commentid: commentID,
                        reactType: typeR,
                        postid: postid,
                        userid: userid,
            ...
            $(document).on('click', '.edit-com-save', function() {
                ...
                var editedTextVal = $(editedText).val();
                $.post('http://localhost/KBPKatta/core/ajax/editComment.php', {
                    postid: postid,
                    userid: userid,
                    editedTextVal: editedTextVal,
                    commentid: commentid
            ...
            $(document).on('click', '.com-reply-action', function() {
                $('.reply-input').empty();
                $('.reply-write').hide();
                var BASE_URL = 'http://localhost/KBPKatta';
                var userid = $(this).data('userid');
                var postid = $(this).data('postid');
                var commentid = $(this).data('commentid');
                ...
                $('input.reply-input-style.reply-submit').keyup(function(e) {
                    if (e.keyCode == 13) {
                        ...
                        if (comment == '') {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "http://localhost/KBPKatta/core/ajax/reply.php",
                                data: {
            ...
            function replyReactSubmit(typeR, postid, userid, commentID, commentparentid, com_nf_3) {
                var profileid = <?php echo $profileId; ?>;
                $.post('http://localhost/KBPKatta/core/ajax/replyReact.php', {
                    commentid: commentID,
                    reactType: typeR,
                    postid: postid,
                    userid: userid,
            ...
            $(document).on('click', '.edit-reply-save', function() {
                ...
                $.post('http://localhost/KBPKatta/core/ajax/editReply.php', {
                    postid: postid,
                    userid: userid,
                    editedTextVal: editedTextVal,
                    commentid: commentid,
            ...
            $(document).on('click', '.post-Share', function() {
                ...
                $.post('http://localhost/KBPKatta/core/ajax/share.php', {
                    shareText: shareText,
                    profileid: profileid,
                    postid: postid,
                    userid: userid
            ...
            $(document).on('click', '.share-container', function() {
                ...
                window.location.href = "http://localhost/KBPKatta/profile.php?username=" + userLink + "";
            })
            ...
            $(document).on('click', '.shared-edit-post-save', function() {
                ...
                var editedTextVal = $(editedText).val();
                $.post('http://localhost/KBPKatta/core/ajax/sharedEditPost.php', {
                    sharedPostid: postid,
                    userid: userid,
                    editedTextVal: editedTextVal
                }, function(data) {
            ...
            $(document).on('keyup', 'input#main-search', function() {
                ...
                if (searchText == '') {
                    ...
                    $.post('http://localhost/KBPKatta/core/ajax/search.php', {
            ...
            $(document).on('click', '.profile-add-friend', function() {
                ...
                $.post('http://localhost/KBPKatta/core/ajax/request.php', {
                    request: profileid,
                    userid: userid
                }, function(data) {
