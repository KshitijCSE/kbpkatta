                    ...
                    <div class="setting-logout-wrap" style="position:relative;margin-top: 41px;display:none;">
                        <div class="s-1-wrap" style="position:absolute;background-color:white;color:gray;padding: 10px 10px; box-shadow: 0 0 5px gray; border-radius: 2px;    margin-left: -60px;">
                            <div class="setting-option align-middle" style="padding:10px;">
                                <img src="settings.png" alt="" style="border-radius:50%; margin-right:5px;">
                                <div>Settings</div>
                            </div>
                            <div class="logout-option align-middle" style="padding:10px;">
                                <img src="logout.png" alt="" style="border-radius:50%;margin-right:5px;">
                                <div>Logout</div>
                            </div>
                        ...
                        <div class="bio-intro">
                            ...
                            <div class="bio-details">
                                <div class="bio-1">
                                    ...
                                    <div class="live-text">Lives in <span class="live-text-css blue">Satara</span></div>
                                </div>
                                <div class="bio-2">
                                    <img src="assets/image/profile/followedBy.JPG" alt="">
                                    <div class="live-text">Studied at <span class="followed-text-css blue">KBPCOES</span></div>
                                </div>
                            </div>
        ...
        $(function() {
            ...
            $(document).on('keyup', '.emojionearea-editor', function() {
                ...
                if (regex_text != null) {
                    ...
                    $.post('http://localhost/KBPKatta/core/ajax/hashtag_mention.php', {
            ...
            $(document).on('click', '.block-show', function() {
                ...
                $.post('http://localhost/KBPKatta/core/ajax/block.php', {
                    profileid: profileid,
                    userid: userid
                }, function(data) {
                    location.reload();
            ...
            function notificationUpdate(userid) {
                $.post('http://localhost/KBPKatta/core/ajax/notify.php', {
                ...
                if (files.length != 0) {
                    if (files.length > 5) {
                        ...
                        for (var i = 0; i < files.length; i++) {
                            ...
                            if (jQuery.inArray(ext, ['gif', 'png', 'jpg', 'jpeg','pdf','mp4','mp3']) == -1) {
            ...
            $(document).on('click', '.postImage', function() {
                ...
                $.post('http://localhost/KBPKatta/core/ajax/imgFetchShow.php', {
                    fetchImgInfo: userid,
                    postid: postid,
                    imageSrc: imageSrc
                }, function(data) {
